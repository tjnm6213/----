    ...
    public partial class Win_com_BuseoJikChaek_U : UserControl
    {
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (!MenuName.Equals("부서"))
            {
                ...
                tbYoungNamikChaekCount.Visibility = Visibility.Visible;
            }
        }
            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        tbYoungNamikChaekCount.Text = "▶검색 결과 : " + i + "건";
                    }
                }
            }
            catch (Exception ex)
        ...
        private void TabControl_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (tabItemBuseo.IsSelected == true)
            {
                ...
                tbYoungNamikChaekCount.Visibility = Visibility.Collapsed;
            }
            else if (tabItemJikChaek.IsSelected == true)
            {
                tblSrh.Text = "직책 검색";
            ...
            try
            {
                if (CheckData())
                {
                    ...
                    else if (tabItemJikChaek.IsSelected == true)
                    {
                        ...
                        sqlParameter.Add("UseClss", chYoungNamikChaekUseClss.IsChecked == true ? "*" : "");
