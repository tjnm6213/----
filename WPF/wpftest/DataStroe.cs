...
using WizMes_YoungNam.Properties;
...
#if DEBUG
        private string ConnectionString = "Data Source=wizis.iptime.org,20150;Initial Catalog=MES_YoungNam;UID=DBUser;PWD=Wizardis; Connection Timeout=0";
        private string LogConnectionString = "Data Source=wizis.iptime.org,20150;Initial Catalog=WizLog;UID=DBUser;PWD=Wizardis; Connection Timeout=0";
#else
